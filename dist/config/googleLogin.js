...
var googleStrategy = exports.googleStrategy = function googleStrategy(passport) {
  passport.use(new _passportGoogleOauth.Strategy({
    clientID: process.env.GOOGLE_CLIENT_ID,
    clientSecret: process.env.GOOGLE_CLIENT_SECRET,
    callbackURL: "/auth/google/callback"
  }, /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(token, tokenSecret, profile, done) {
      var user;
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _useModal["default"].findById(id);
          case 3:
            user = _context2.sent;
            done(null, user);
            _context2.next = 10;
